...
<p> Olá! Me chamo José Wellington, tenho 20 anos, sou desenvolvedor web e mobile e desde pequeno sempre gostei da área de tecnologia. Tenho curso de desenvolvedor front-end, feito na plataforma de ensino da softex de recife, onde o mesmo consistiu em um processo seletivo com quase 10 mil candidatos para selecionar somente mil para a realização do curso. Atualmente estou aprimorando meus conhecimentos sobre desenvolvimento de sites e desenvolvimento de aplicativos, em específico na parte de front-end, logo logo estarei me atualizando também sobre as tecnologias utilizadas no back-end. Atualmente, estou participando de dois projetos no Laboratório Multidisciplinar de Tecnologias Sociais (LMTS) na UFAPE. Um deles consiste em um aplicativo para ajudar a comunidade acadêmica da UFAPE a ter mais facilidade no acesso a informações. Além disso, estou envolvido na elaboração de um sistema de gerenciamento agrícola para os agricultores de Bonito-PE. Gosto também de ler livros de ficção e PDFs relacionados à programação.  as tecnologias usadas no projeto são: html, css, javascript, node js, react JS, dart e flutter.</p>
